    ...
    <Card>
      ...
      <template #content>
        ...
        >
            ...
            >
              <div class="flex flex-col gap-2 text-right">
                ...
                <InputNumber
                  ...
                  placeholder=""
                  :class="{ 'p-invalid': errorMessage || fieldErrors.quantity }"
                />
          ...
          <div
            class="rounded-2xl border border-dashed border-slate-400 bg-slate-100 p-4 text-right text-sm text-slate-700"
          >
...
const form = reactive({ branch: "", date: "", product: "", quantity: null });
const initialValues = { branch: "", date: "", product: "", quantity: null };
