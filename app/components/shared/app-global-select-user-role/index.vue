...
import { USER_ROLE_OPTIONS } from "~/enums/userRole";

defineOptions({ name: "AppGlobalSelectUserRole" });

const props = defineProps({
  modelValue: { type: [String, Number], default: null },
  /** Override options; defaults to global user role options */
  options: { type: Array, default: null },
  label: { type: String, default: "الدور" },
  labelClass: { type: String, default: "text-slate-700" },
  wrapperClass: { type: String, default: "" },
  selectClass: { type: String, default: "" },
  placeholder: { type: String, default: "اختر الدور" },
...
const resolvedOptions = computed(() =>
  Array.isArray(props.options) ? props.options : [...USER_ROLE_OPTIONS],
);
