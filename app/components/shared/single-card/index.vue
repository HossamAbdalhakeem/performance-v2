<template>
  <div class="overflow-hidden rounded-lg border border-forest/40 bg-forest/10 transition hover:shadow-lg">
    <!-- <SharedWrapperImage :loading="loading">
      <img
        v-if="card.image"
        :src="card.image"
        :alt="card.title"
    ...
    <div class="p-4">
      ...
      <SharedWrapperButtonSection v-if="loading" :loading="loading" class="mt-4 border-0 p-0">
        <button
